...
interface Member { id: number; full_name: string; login: string; role_name: string; role_code: string; is_active?: boolean; last_login_at?: string | null; }

function MembersModal({ project, onClose, onChanged }: { project: Project; onClose: () => void; onChanged: () => void }) {
...
function ProjectCard({ p, onEdit, onArchive, onMembers }: { p: Project; onEdit: () => void; onArchive: () => void; onMembers: () => void }) {
